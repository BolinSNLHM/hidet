...
hidet.option.cache_dir("./NODYNAMIC-NEWcache-branchISlike-ansor-128")
...
for n, m, k in [(128, 128, 128)]:
    ...
    with open(f"./NODYNAMIC-NEWperf-branchISlike-ansor-128.txt", 'a+') as f:
        f.write('%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%\n\n')
